...
public class Misc {
	...
	/**
	 * Gets a random from 0 to range (inclusive)
	...
	public static String currency(final long quantity, boolean coinsTextShown) {
	...
	public static String insertCommasToNumber(int number) {
		return insertCommasToNumber(String.valueOf(number));
	}
