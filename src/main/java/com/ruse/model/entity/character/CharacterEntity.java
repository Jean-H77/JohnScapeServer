...
public abstract class CharacterEntity extends Entity {
	...
	public CharacterEntity(Position position) {
		super(position);
	...
	/*** ABSTRACT METHODS ***/
	public abstract CharacterEntity setConstitution(int constitution);
	public abstract CombatStrategy determineStrategy();
	public abstract void appendDeath();
	public abstract void heal(int damage);
	public abstract void poisonVictim(CharacterEntity victim, CombatType type);
	 ...
	 * @param hit the hit
	 */
	public abstract void damaged(Hit hit);

	/**
	 * This entity attacked another one.
	 * @param hit the hit
	 */
	public abstract void attacked(CharacterEntity victim, Hit hit);

	/**
	 * Modify the hit.
	 * @param hit the hit
	 */
	public abstract void modifyHit(Hit hit);

	/**
	 * Called when the entity respawned.
	 */
	...
	public CharacterEntity setGraphic(Graphic graphic) {
	...
	public CharacterEntity setAnimation(Animation animation) {
	...
	public void dealDamage(Hit hit) {
		...
		if (getUpdateFlag().flagged(Flag.SINGLE_HIT)) {
			...
			if (hit.getAttacker() != null) {
				hit.getAttacker().attacked(this, hit);
			}
			damaged(hit);
			return;
		}
	 ...
	 */
	public void prepareSpell(CombatSpell spell, CharacterEntity victim) {
	...
	public CharacterEntity setPositionToFace(Position positionToFace) {
	...
	public CharacterEntity moveTo(Position teleportTarget) {
	...
	public CharacterEntity setMovementQueue(MovementQueue movementQueue) {
	...
	public CharacterEntity forceChat(String message) {
		setForcedChat(message);
		getUpdateFlag().flag(Flag.FORCED_CHAT);
		return this;
	}

	public CharacterEntity setEntityInteraction(Entity entity) {
    ...
    /**
     * Sets the value for {@link CharacterEntity#secondaryDirection}.
     *
    ...
    /**
     * Sets the value for {@link CharacterEntity#lastDirection}.
     *
     * @param lastDirection
     *            the new value to set.
     */
	...
	public CharacterEntity setTeleporting(boolean teleporting) {
	...
	public CharacterEntity setForcedChat(String forcedChat) {
	...
	public CharacterEntity setPrayerActive(boolean[] prayerActive) {
		this.prayerActive = prayerActive;
		return this;
	}

	public CharacterEntity setPrayerActive(int id, boolean prayerActive) {
		this.prayerActive[id] = prayerActive;
		return this;
	}

	public CharacterEntity setCurseActive(boolean[] curseActive) {
		this.curseActive = curseActive;
		return this;
	}

	public CharacterEntity setCurseActive(int id, boolean curseActive) {
	...
	public CharacterEntity setNpcTransformationId(int npcTransformationId) {
    ...
    /**
     * Sets the value for {@link CharacterEntity#resetMovementQueue}.
     *
