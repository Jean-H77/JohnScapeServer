 ...
 */
public final class CharacterList<E extends CharacterEntity> implements Iterable<E> {
	...
	public CharacterList(int capacity) {
		...
		this.characters = (E[]) new CharacterEntity[capacity];
		this.size = 0;
	}
	...
	public void clear() {
		forEach(this::remove);
		characters = (E[]) new CharacterEntity[capacity];
		size = 0;
	}
	 ...
	 * @author lare96 <http://github.com/lare96>
	 */
	private static final class CharacterListIterator<E extends CharacterEntity> implements Iterator<E> {
