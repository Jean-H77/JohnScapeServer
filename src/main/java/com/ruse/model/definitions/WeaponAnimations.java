...
public final class WeaponAnimations {
	...
	public static CharacterAnimations getUpdateAnimation(Player player) {
		...
		if (weaponName.contains("halberd") || weaponName.contains("guthan") || weaponName.contains("scythe")) {
	...
	public static int getAttackAnimation(Player c) {
		...
		if (weaponName.contains("karil"))
			return 2075;
		else if (weaponName.contains("'bow") || weaponName.contains("crossbow") || weaponName.contains("pistol"))
			return 4230;
