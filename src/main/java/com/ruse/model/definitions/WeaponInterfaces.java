...
public final class WeaponInterfaces {
	...
	public enum WeaponInterface {
		...
		WARHAMMER(425, 428, 4, new FightType[] { FightType.WARHAMMER_POUND,	FightType.WARHAMMER_PUMMEL, FightType.WARHAMMER_BLOCK }, 7474, 7486),
		...
		DAGGER(2276, 2279, 3, new FightType[] { FightType.DAGGER_STAB,FightType.DAGGER_LUNGE, FightType.DAGGER_SLASH,FightType.DAGGER_BLOCK }, 7574, 7586),
		SWORD(2276, 2279, 3, new FightType[] { FightType.SWORD_STAB,FightType.SWORD_LUNGE, FightType.SWORD_SLASH,FightType.SWORD_BLOCK }, 7574, 7586),
		SCIMITAR(2423, 2426, 3, new FightType[] { FightType.SCIMITAR_CHOP,FightType.SCIMITAR_SLASH, FightType.SCIMITAR_LUNGE,FightType.SCIMITAR_BLOCK }, 7599, 7611),
		LONGSWORD(2423, 2426, 4, new FightType[] { FightType.LONGSWORD_CHOP,FightType.LONGSWORD_SLASH, FightType.LONGSWORD_LUNGE,FightType.LONGSWORD_BLOCK }, 7599, 7611),
	...
	public static JsonLoader parseInterfaces() {
		return new JsonLoader() {
			...
			public String filePath() {
				return GameSettings.DEFINITION_DIRECTORY + "weapon_interfaces.json";
			}
		};
	}
}
