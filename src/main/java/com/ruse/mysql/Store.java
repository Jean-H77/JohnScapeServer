...
public class Store implements Runnable {
	...
	public static final String HOST = "JohnScape.org"; // website ip address
	public static final String USER = "JohnScape_store_u";
	public static final String PASS = "wKeYwBv69Zl8LLs!";
	public static final String DATABASE = "JohnScape_store_u";
