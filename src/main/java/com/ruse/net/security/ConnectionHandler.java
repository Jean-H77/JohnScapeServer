...
public class ConnectionHandler {
	...
	private static final String BLACKLIST_DIR = GameSettings.SANCTION_DIRECTORY + "blockedhosts.txt";
	private static List<String> BLACKLISTED_HOSTNAMES = new ArrayList<String>();
	
	
	private static final String BLACKLISTED_MACS_DIR = GameSettings.SANCTION_DIRECTORY + "BannedMacs.txt";
	private static List<String> BLACKLISTED_MACS = new ArrayList<String>();
	
	private static final String BLACKLISTED_UUIDS_DIR = GameSettings.SANCTION_DIRECTORY + "BannedUUIDs.txt";
	...
	private static void loadHostBlacklist() {
		String word = null;
		try {
			FileUtils.createNewFile(BLACKLIST_DIR);
	...
	private static void loadMacBans() {
		String line = null;
		try {
			FileUtils.createNewFile(BLACKLISTED_MACS_DIR);
	...
	private static void loadUUIDBans() {
		String line = null;
		try {
			FileUtils.createNewFile(BLACKLISTED_UUIDS_DIR);
	...
	public static void loadStarters() {
		try {
			FileUtils.createNewFile(STARTER_FILE);
