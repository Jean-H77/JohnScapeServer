...
import com.ruse.world.content.skill.mining.MiningData;
import com.ruse.world.content.skill.mining.Prospecting;
import com.ruse.world.content.skill.runecrafting.Runecrafting;
import com.ruse.world.content.skill.runecrafting.RunecraftingData;
...
import com.ruse.world.content.skill.woodcutting.Woodcutting;
	...
	private static void firstClick(final Player player, Packet packet) {
		...
		player.setInteractingObject(gameObject).setWalkToTask(new WalkToTask(player, position, gameObject.getSize(), new FinalizedMovementTask() {
			...
			public void execute() {
					...
					case 1730:
						if(player.getPosition().getZ()==0) {
							if(!player.isFirstFloorCastle())
								player.getPacketSender().sendMessage("@red@You need to give John a ghoulish key to continue");
							else
								player.moveTo(new Position(3110, 3035, 1));
						} else if(player.getPosition().getZ()==1) {
							if(!player.isSecondFloorCastle())
								player.getPacketSender().sendMessage("@red@You need to give the monk a bone key to continue");
							else
								player.moveTo(new Position(3110, 3035, 2));
						}else if(player.getPosition().getZ()==2) {
							if(!player.isThirdFloorCastle())
								player.getPacketSender().sendMessage("@red@You need to give the vampire a blood key to continue");
							else
				...
				case 17953:
					...
					case 10168:
						if(player.getPosition().getX()==2138 && player.getPosition().getY()==5105 && player.getPosition().getZ()==1) {
							...
							player.delayedMoveTo(new Position(2138, 5105, 0), 2);
						}
						break;
					case 10167:
						if(player.getPosition().getX()==2138 && player.getPosition().getY()==5105 && player.getPosition().getZ()==0) {
							player.performAnimation(new Animation(828));
							player.delayedMoveTo(new Position(2138, 5105, 1), 2);
						}
						break;
					case 10137:
						if(player.getPosition().getX()==2130 && player.getPosition().getY()==5096 && player.getPosition().getZ()==1) {
							player.moveTo(new Position(2129, 5093, 0));
						} else if(player.getPosition().getX()==2137 && player.getPosition().getY()==5089 && player.getPosition().getZ()==1) {
							player.moveTo(new Position(2140, 5088, 0));
						} else if(player.getPosition().getX()==2149 && player.getPosition().getY()==5089 && player.getPosition().getZ()==1) {
							player.moveTo(new Position(2152, 5088, 0));
						} else if(player.getPosition().getX()==2163 && player.getPosition().getY()==5089 && player.getPosition().getZ()==1) {
							player.moveTo(new Position(2166, 5088, 0));
						}
						break;
					case 10136:
						if(player.getPosition().getX()==2129 && player.getPosition().getY()==5093 && player.getPosition().getZ()==0) {
							player.moveTo(new Position(2130, 5096, 1));
						} else if(player.getPosition().getX()==2140 && player.getPosition().getY()==5088 && player.getPosition().getZ()==0) {
							player.moveTo(new Position(2137, 5089, 1));
						} else if(player.getPosition().getX()==2152 && player.getPosition().getY()==5088 && player.getPosition().getZ()==0) {
							player.moveTo(new Position(2149, 5089, 1));
						} else if(player.getPosition().getX()==2166 && player.getPosition().getY()==5088 && player.getPosition().getZ()==0) {
							player.moveTo(new Position(2163, 5089, 1));
						}
						break;
				case 28296:
				...
				case 28714:
					player.performAnimation(new Animation(828));
					player.delayedMoveTo(new Position(3088, 3495), 2);
					break;
				case 26933:
					player.performAnimation(new Animation(827));
