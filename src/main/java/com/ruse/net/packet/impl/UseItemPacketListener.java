...
import com.ruse.world.content.skill.firemaking.Firelighter;
...
import com.ruse.world.content.skill.herblore.Crushing;
import com.ruse.world.content.skill.herblore.Herblore;
import com.ruse.world.content.skill.herblore.PotionCombinating;
...
public class UseItemPacketListener implements PacketListener {
	...
	private static void itemOnItem(Player player, Packet packet) {
		...
		if (RecoilRing.itemOnItem(player, usedWith, itemUsedWith) || RecoilRing.itemOnItem(player, itemUsedWith, usedWith)) {
			return;
		}
