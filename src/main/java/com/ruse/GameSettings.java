...
public class GameSettings {
	...
	public static final String RSPS_NAME = "JohnScape";
	public static final String DEFAULT_CLAN_OWNER = "John";
	public static final String BCRYPT_EXAMPLE_SALT = "$2a$09$kCPIaYJ6vJmzJM/zq8vuSO";
	public static final String GAME_CONFIGURATION_FILE = "./data/config.yaml";

	/**
	 * WEB URLS
	 */
	public static final String DomainUrl = "www.JohnScape.org/";
	...
	public static final String RankFeaturesUrl = DomainUrl+"forums/showthread.php?tid=147";
	public static final String WikiaUrl = "www.JohnScape.wikia.com";
	public static final String IronManModesUrl = DomainUrl+"forums/showthread.php?tid=12";
	...
	public static final String SANCTION_DIRECTORY = "./data/saves/sanctions/";
	public static final String DEFINITION_DIRECTORY = "./data/def/";
	...
	public static final int charcterSavingInterval = 2000000;
	...
	*/
	...
	public static final int[] UNTRADEABLE_ITEMS = 
		...
		2683, 2684, 2685, 2686, 2687, 2688, 2689, 2690, 11180,
				12158, 12159, 12160, 12163, 12161, 12162,
	...
	public static final int UNSELLABLE_ITEMS[] = new int[] {
		...
		20671, //Brackish
			14462,  14471, 14496,
		20135, 20139, 20143, 20147, 20151, 20155, 20159, 20163, 20167, //Nex armors15103, 15104, 15106, 15105, //Fire cape
