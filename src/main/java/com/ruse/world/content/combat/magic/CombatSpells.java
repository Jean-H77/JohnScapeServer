...
/**
 * Holds all of the {@link CombatSpell}s that can be cast by an {@link CharacterEntity}.
 * 
 * @author lare96
 */
public enum CombatSpells {
	...
	WIND_STRIKE(new CombatNormalSpell() {
		...
		@Override
		public Optional<Projectile> castProjectile(CharacterEntity cast, CharacterEntity castOn) {
	...
	CONFUSE(new CombatEffectSpell() {
		...
		@Override
		public void spellEffect(CharacterEntity cast, CharacterEntity castOn) {
			if (castOn.isPlayer()) {
	...
	SMOKE_RUSH(new CombatAncientSpell() {
		@Override
		public void spellEffect(CharacterEntity cast, CharacterEntity castOn, int damage) {
