...
public abstract class CombatSpell extends Spell {
	...
	@Override
	public void startCast(CharacterEntity cast, CharacterEntity castOn) {
		...
		if(cast.isPlayer()) {
			System.out.println(  ((Player)cast).getUsername() );
		}
	...
	/**
	 * The maximum hit an {@link CharacterEntity} can deal with this spell.
	 * 
	 ...
	 */
	public abstract Optional<Projectile> castProjectile(CharacterEntity cast,
                                                        CharacterEntity castOn);
	 ...
	 */
	public abstract void finishCast(CharacterEntity cast, CharacterEntity castOn,
