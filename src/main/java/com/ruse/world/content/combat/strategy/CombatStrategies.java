...
import com.ruse.world.content.combat.strategy.impl.DemonicGorilla;
import com.ruse.world.content.combat.strategy.impl.bosses.*;
...
import com.ruse.world.content.combat.strategy.impl.bosses.gwd.Graardor;
import com.ruse.world.content.combat.strategy.impl.bosses.gwd.Grimspike;
import com.ruse.world.content.combat.strategy.impl.bosses.gwd.Gritch;
import com.ruse.world.content.combat.strategy.impl.bosses.gwd.Growler;
import com.ruse.world.content.combat.strategy.impl.IceQueen;
import com.ruse.world.content.combat.strategy.impl.Kilik;
import com.ruse.world.content.combat.strategy.impl.bosses.gwd.KreeArra;
...
import com.ruse.world.content.combat.strategy.impl.bosses.gwd.Steelwill;
import com.ruse.world.content.combat.strategy.impl.TormentedDemon;
import com.ruse.world.content.combat.strategy.impl.bosses.gwd.Tsutsuroth;
import com.ruse.world.content.combat.strategy.impl.bosses.gwd.WingmanSkree;
import com.ruse.world.content.combat.strategy.impl.bosses.gwd.Zilyana;
 ...
 public class CombatStrategies {
	...
	public static void init() {
		...
		STRATEGIES.put(352, defaultMagicStrategy);
		...
		STRATEGIES.put(8777, defaultRangedStrategy);
		STRATEGIES.put(351, defaultRangedStrategy);
		...
		STRATEGIES.put(39472, new WitchDoctor());
