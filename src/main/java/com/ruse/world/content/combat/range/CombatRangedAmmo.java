...
public class CombatRangedAmmo {
	...
	public enum RangedWeaponData {
		...
		ZARYTE_BOW(new int[] {20171, 904, 905}, new AmmunitionData[] {AmmunitionData.ZARYTE_AMMO}, RangedWeaponType.SHORTBOW),
		...
		PISTOL(new int[]{9307}, new AmmunitionData[] {AmmunitionData.HAND_CANNON_SHOT}, RangedWeaponType.CROSSBOW);
	...
	//AmnitionData(int[] itemIds, int startGfxId, int projectileId, int projectileSpeed, int projectileDelay, int strength, int startHeight, int endHeight) {
		...
		IRON_ARROW(new int[] {884}, 18, 9, 3, 44, 0, 43, 31),
		STEEL_ARROW(new int[] {886}, 20, 11, 3, 44, 0, 43, 31),
		MITHRIL_ARROW(new int[] {888}, 21, 12, 3, 44, 0, 43, 31),
		ADAMANT_ARROW(new int[] {890}, 22, 13, 3, 44, 0, 43, 31),
		RUNE_ARROW(new int[] {892}, 24, 15, 3, 44, 0, 43, 31),
		ICE_ARROW(new int[]{78}, 25, 16, 3, 44, 0, 34, 31),
		BROAD_ARROW(new int[] {4160}, 20, 11, 3, 44, 0, 43, 31),
		DRAGON_ARROW(new int[] {11212}, 1111, 1120, 3, 44, 0, 43, 31),

		BRONZE_BOLT(new int[] {877}, -1, 27, 3, 44, 0, 43, 31),
		OPAL_BOLT(new int [] {879, 9236}, -1, 27, 3, 44, 0, 43, 31),
		IRON_BOLT(new int[] {9140}, -1, 27, 3, 44, 0, 43, 31),
		JADE_BOLT(new int[] {9335, 9237}, -1, 27, 3, 44, 0, 43, 31),
		STEEL_BOLT(new int[] {9141}, -1, 27, 3, 44, 0, 43, 31),
		PEARL_BOLT(new int[] {880, 9238}, -1, 27, 3, 44, 0, 43, 31),
		MITHRIL_BOLT(new int[] {9142}, -1, 27, 3, 44, 0, 43, 31),
		TOPAZ_BOLT(new int[] {9336, 9239}, -1, 27, 3, 44, 0, 43, 31),
		ADAMANT_BOLT(new int[] {9143}, -1, 27, 3, 44, 0, 43, 31),
		SAPPHIRE_BOLT(new int[] {9337, 9240}, -1, 27, 3, 44, 0, 43, 31),
		EMERALD_BOLT(new int[] {9338, 9241}, -1, 27, 3, 44, 0, 43, 31),
		RUBY_BOLT(new int[] {9339, 9242}, -1, 27, 3, 44, 0, 43, 31),
		RUNITE_BOLT(new int[] {9144}, -1, 27, 3, 44, 0, 43, 31),
		BROAD_BOLT(new int[] {13280}, -1, 27, 3, 44, 0, 43, 31),
		...
		STEEL_KNIFE(new int[] {865, 872, 5656}, 221, 214, 4, 33, 0, 45, 37),
		BLACK_KNIFE(new int[] {869, 874, 5658}, 222, 215, 4, 33, 0, 45, 37),
		MITHRIL_KNIFE(new int[] {866, 873, 5657}, 223, 215, 4, 33, 0, 45, 37),
		ADAMANT_KNIFE(new int[] {867, 875, 5659}, 224, 217, 4, 33, 0, 45, 37),
		RUNE_KNIFE(new int[] {868, 876, 5660, 5667}, 225, 218, 4, 33, 0, 48, 37),
		
		BRONZE_THROWNAXE(new int[] {800}, 43, 36, 3, 44, 0, 43, 31),
		IRON_THROWNAXE(new int[] {801}, 42, 35, 3, 44, 0, 43, 31),
		STEEL_THROWNAXE(new int[] {802}, 44, 37, 3, 44, 0, 43, 31),
		MITHRIL_THROWNAXE(new int[] {803}, 45, 38, 3, 44, 0, 43, 31),
		ADAMANT_THROWNAXE(new int[] {804}, 46, 39, 3, 44, 0, 43, 31),
		RUNE_THROWNAXE(new int[] {805}, 48, 41, 3, 44, 0, 43, 31),
		MORRIGANS_THROWNAXE(new int[] {13883, 13957}, 1856, -1, 3, 0, 100, 43, 31),

		BRONZE_JAVELIN(new int[] {825}, 206, 200, 2, 40, 0, 45, 37),
		IRON_JAVELIN(new int[] {826}, 207, 201, 2, 40, 0, 45, 37),
		STEEL_JAVELIN(new int[] {827}, 208, 202, 2, 40, 0, 45, 37),
		MITHRIL_JAVELIN(new int[] {828}, 209, 203, 2, 40, 0, 45, 37),
		ADAMANT_JAVELIN(new int[] {829}, 210, 204, 2, 40, 0, 45, 37),
		RUNE_JAVELIN(new int[] {830}, 211, 205, 2, 40, 0, 45, 37),
		MORRIGANS_JAVELIN(new int[] {13879, 13953}, 1855, -1, 2, 0, 100, 45, 37),

		TOKTZ_XIL_UL(new int[]{6522}, -1, 442, 2, 40, 0, 51, 37),
		...
		BRONZE_DART(new int[] {806}, -1, 226, 4, 33, 0, 20, 28),
		IRON_DART(new int[] {807}, -1, 227, 4, 33, 0, 20, 28),
		STEEL_DART(new int[] {808}, -1, 228, 4, 33, 0, 20, 28),
		MITHRIL_DART(new int[] {809}, -1, 229, 4, 33, 0, 20, 28),
		ADAMANT_DART(new int[] {810}, -1, 230, 4, 33, 0, 20, 28),
		RUNE_DART(new int[] {811}, -1, 231, 4, 33, 0, 20, 28),
		DRAGON_DART(new int[] {11230}, -1, 226, 4, 33, 0, 20, 28);
