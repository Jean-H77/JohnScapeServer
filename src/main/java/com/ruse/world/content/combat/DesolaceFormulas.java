...
public class DesolaceFormulas {
	...
	public static int getMeleeMaxHit(CharacterEntity entity, CharacterEntity victim) {
		double maxHit = 0;
		if (entity.isNpc()) {
			NPC npc = (NPC) entity;
	 ...
	 */
	public static int getMagicMaxHit(CharacterEntity c) {
		int damage = 0;
		...
		damageMultiplier += p.getBonusManager().getOtherBonus()[3] / 100;
