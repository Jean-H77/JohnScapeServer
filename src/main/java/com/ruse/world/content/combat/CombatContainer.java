...
public class CombatContainer {
	...
	public void setHitGraphic(Graphic hitGraphic) {
	 ...
	 *            if accuracy should be taken into account.
	 */
	public CombatContainer(CharacterEntity attacker, CharacterEntity victim, int hitAmount, CombatType hitType, boolean checkAccuracy) {
	...
	public CombatContainer(CharacterEntity attacker, CharacterEntity victim, int hitAmount, int hitDelay, CombatType hitType, boolean checkAccuracy) {
		this.attacker = attacker;
		this.victim = victim;
		this.combatType = hitType;
		this.checkAccuracy = checkAccuracy;
	...
	public CombatContainer(CharacterEntity attacker, CharacterEntity victim, int hitAmount, int hitDelay, Graphic hitGraphic, CombatType hitType, boolean checkAccuracy) {
		this.attacker = attacker;
		this.victim = victim;
		this.combatType = hitType;
		this.checkAccuracy = checkAccuracy;
	...
	public CombatContainer(CharacterEntity attacker, CharacterEntity victim, int hitAmount, int hitDelay, CombatType hitType, boolean checkAccuracy, int maxHit) {
		this.maxHit = maxHit;
		this.attacker = attacker;
		this.victim = victim;
		this.combatType = hitType;
	 ...
	 *            if accuracy should be taken into account.
	 */
	public CombatContainer(CharacterEntity attacker, CharacterEntity victim, CombatType hitType, boolean checkAccuracy) {
	...
	public final int getDamage() {
		...
		for (ContainerHit hit : hits) {
			...
			if (!hit.accurate) {
				...
				hit.hit = new Hit(hit.getHit().getAttacker(), 0, Hitmask.RED, CombatIcon.BLOCK, true);
