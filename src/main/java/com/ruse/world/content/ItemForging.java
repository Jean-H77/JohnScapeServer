...
public class ItemForging {
	...
	private static enum ItemForgeData {
		...
		ZENYTE_SHARD_TO_ZENYTE_GEM(new Item[] {new Item(Items.ZENYTE_SHARD), new Item(Items.UNCUT_ONYX)}, new Item(Items.UNCUT_ZENYTE), new int[] {Skill.CRAFTING.ordinal(), 89, 0}),
