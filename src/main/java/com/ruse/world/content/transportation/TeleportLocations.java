...
public enum TeleportLocations {
	...
	BANISHED_FOUR(new Position(3297, 9824, 0), ""),

	EXPERIMENTS(new Position(3558, 9948, 0), ""),
	TORMENTED_DEMONS(new Position(2404, 9415, 0), ""),
	...
	DEMONIC_GORILLAS(new Position(2106, 5649, 0), ""),
	...
	SISTER_SENGA(new Position(2144, 5007, 0), "Oooh, it's quite cold up here."),

	INFERNAL_PYRELORD(new Position(2656, 9827, 0), "Oooh, it's quite hot up here."),
